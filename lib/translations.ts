...
export const translations = {
  en: {
    ...
    hero: {
      title_part1: "Digital solutions ",
      title_gradient: "that truly support ",
      title_part2: " your business.",
      description: "We create websites, development solutions, and custom software that are easy to use, well thought out, and tailored to your goals.",
  ...
  hu: {
    ...
    hero: {
      title_part1: "Digitális megoldások, ",
      title_gradient: "amik valóban támogatják ",
      title_part2: " a vállalkozásodat.",
      description: "Weboldalt, fejlesztést és egyedi szoftvert készítünk úgy, hogy az könnyen használható, átgondolt és a céljaidhoz illeszkedő legyen.",
